...
\usepackage{cite, tocbibind, subfiles, float, amsmath, textcomp, graphicx, wrapfig, enumitem, cancel, datetime, tabularx, titlesec, hyperref, natbib, setspace, subfigure, url, multirow}
\tolerance=1000
\usdate
\usepackage[letterpaper, portrait, top = 1in, left = 1in, right = 1.25in, bottom = 1.5in, headheight=23pt]{geometry}
\linespread{1.5}
