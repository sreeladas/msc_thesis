...
\usepackage{cite, tocbibind, subfiles, float, amsmath, amssymb, textcomp, graphicx, wrapfig, enumitem, cancel, datetime, titlesec, hyperref, natbib, setspace, subfigure, url}
\tolerance=1000
\usdate
