...
The night sky background (NSB) level is also a priori expected to influence the reconstruction efficiency. A higher level of NSB photons increases the threshold needed to remove background photons, thereby causing a greater loss of lower energy gamma rays. This decreases the sensitivity to lower energy photons and affects the gamma-ray effective area.
