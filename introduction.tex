...
\begin{figure}[htbp]
  \centering
    \subfigure[The image axis parameter is the line of best fit for the shower image on a single telescope. This best fit is measured by minimizing the signal-weighted sum of squares of residuals. Picture taken from \cite{veritas_web}]{ 
