...
\usepackage{cite, tocbibind, subfiles, float, amsmath, textcomp, graphicx, wrapfig, enumitem, cancel, datetime, tabularx, titlesec, hyperref, natbib, setspace, subfigure, url}
\tolerance=1000
\usdate
