...
\begin{figure}[H]
  \begin{center}
    \subfigure[A histogram of the 2D projection of the angular deviation of the reconstructed direction. The colors denote the number of entries in a given bin.]{ 
...
\begin{figure}[H]
  \begin{center}
    \subfigure[Numerically determined R$_{68}$.]{
      \includegraphics[width=0.47\linewidth]{num/disp_standard_ratio_xzen}
      \label{fig:olddisp_ratio_num}
    }
    \subfigure[R$_{68}$ as determined from a fit.]{
      \includegraphics[width=0.47\linewidth]{fit/disp_standard_ratio_xzen}
...
\begin{figure}[H]
  \centering
    \subfigure[Numerically determined R$_{68}$.]{
      \includegraphics[width=0.47\linewidth]{num/disp_250_ratio_xzen}
      \label{fig:disp_ratio_250_num}
    }
    \subfigure[R$_{68}$ as determined from a fit.]{
      \includegraphics[width=0.47\linewidth]{fit/disp_250_ratio_xzen}
...
\begin{figure}[htbp]
  \centering
  \subfigure[Numerically determined R$_{68}$.]{
    \includegraphics[width=.47\linewidth]{num/disp_450_ratio_xzen}
    \label{fig:disp_ratio_450_num}
  }
  \subfigure[R$_{68}$ as determined from a fit.]{
    \includegraphics[width=0.47\linewidth]{fit/disp_450_ratio_xzen}
...
\begin{figure}[htbp]
  \centering
  \subfigure[Numerically determined R$_{68}$.]{
    \includegraphics[width=0.47\linewidth]{num/disp_450x4size_ratio_xzen}
    \label{fig:disp_ratio_450x4_num}
  }
  \subfigure[R$_{68}$ as determined from a fit.]{
    \includegraphics[width=0.47\linewidth]{fit/disp_450x4size_ratio_xzen}
...
\begin{figure}[htbp]
  ...
  \subfigure[Energy Dependence of Method0 at small and medium zenith angles.]{
    \includegraphics[width=.47\linewidth]{num/reg_SZA_energy}
    \label{fig:energy_reg_SZA}
  }
  \subfigure[Energy Dependence of Method0 at large zenith angles.]{
    \includegraphics[width=.47\linewidth]{num/reg_LZA_energy}
...
\begin{figure}[H]
  \begin{center}
    \subfigure[Crab skymap for $\phi<50^\circ$ and $E<1$ TeV.]{ 
      \includegraphics[width=0.47\linewidth]{num/LZA_data_25/crab_all_disp_skymap_SZA_LE.png}
      \label{fig:crab_skymap_SZA_LE}
    }  
    \subfigure[Crab skymap for $\phi\geq50^\circ$ and $E<1$ TeV.]{ 
      \includegraphics[width=0.47\linewidth]{num/LZA_data_25/crab_all_disp_skymap_LZA_LE.png}
      \label{fig:crab_skymap_LZA_LE}
    }
    \subfigure[Crab skymap for $\phi<50^\circ$ and $E\geq1$ TeV.]{ 
      \includegraphics[width=0.47\linewidth]{num/LZA_data_25/crab_all_disp_skymap_SZA_HE.png}
      \label{fig:crab_skymap_SZA_HE}
    }  
    \subfigure[Crab skymap for $\phi\geq50^\circ$ and $E\geq1$ TeV.]{ 
      \includegraphics[width=0.47\linewidth]{num/LZA_data_25/crab_all_disp_skymap_LZA_HE.png}
      \label{fig:crab_skymap_LZA_HE}
    }
  \end{center}
  \caption[Crab skymaps using the new \disp tables.]{Reconstruction of the Crab direction using Method5t and with data runs such that the mean zenith angle was $\phi\geq40$, with the colors providing a log-scale representation of the number of excess events at a given 2D deviation from the source location. We can see that (d) has more events closer to the center of the skymap than (a), and while a similar effect may be visible in (b) and (c), those effects are washed out by small statistics and low significance.}
  \label{fig:crab_skymaps}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \subfigure[Crab skymap for $\phi<50^\circ$ and $E<1$ TeV.]{ 
      \includegraphics[width=0.47\linewidth]{num/LZA_data_25/Mrk421_skymap_SZA_LE.png}
      \label{fig:Mrk421_skymap_SZA_LE}
    }  
    \subfigure[Crab skymap for $\phi>50^\circ$ and $E<1$ TeV.]{ 
      \includegraphics[width=0.47\linewidth]{num/LZA_data_25/Mrk421_skymap_LZA_LE.png}
      \label{fig:Mrk421_skymap_LZA_LE}
    }
    \subfigure[Crab skymap for $\phi<50^\circ$ and $E>1$ TeV.]{ 
      \includegraphics[width=0.47\linewidth]{num/LZA_data_25/Mrk421_skymap_SZA_HE.png}
      \label{fig:Mrk421_skymap_SZA_HE}
    }  
    \subfigure[Crab skymap for $\phi>50^\circ$ and $E>1$ TeV.]{ 
      \includegraphics[width=0.47\linewidth]{num/LZA_data_25/Mrk421_skymap_LZA_HE.png}
      \label{fig:Mrk421_skymap_LZA_HE}
    }
  \end{center}
